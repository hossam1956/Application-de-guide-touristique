...
//add model.........................................................................
static async addCreateurs(nom, biographie, date_n,photo ) {
    return new Promise(resolve => {
      ...
      const formattedDate = moment(date_n).format('YYYY-MM-DD');
      db.query("INSERT INTO createur (nom, biographie, date_n, photo) VALUES (?, ?, ?, ?)",
        [nom, biographie, formattedDate, imagesString], (error, results) => {
          if (!error) {
            resolve(true);
          } else {
...
static async updateCreateur(createurtId, newData) {
    newData.date_n = moment(newData.date_n).format('YYYY-MM-DD');
    // Check if images is an array
